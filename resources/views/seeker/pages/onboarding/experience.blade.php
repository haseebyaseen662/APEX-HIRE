{{-- resources/views/seeker/onboarding/experience.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    <meta content="width=device-width, initial-scale=1.0" name="viewport"/>
    <title>Work Experience — Apex Hire</title>
...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen flex flex-col antialiased">
        ...
        <div class="w-full max-w-3xl flex flex-col gap-8">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <span class="text-sm font-semibold text-primary" id="step-counter">Step 2 of 2</span>
                    ...
                    <div id="experienceEntries" class="space-y-8">
                        ...
                        <div class="experience-entry space-y-6" data-index="1">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-1">
                                    <label class="text-sm font-semibold text-slate-700 dark:text-slate-300" for="jobPosition0">
                                    ...
                                    />
                                    <p class="text-xs text-red-500 hidden mt-1" data-error="jobPosition0"></p>
    ...
    {{-- ============================================================
         JS — Dynamic "Add Another Experience" entries & Validation
    ============================================================ --}}
    <script>
        let entryCount = 1;
            ...
            <div class="experience-entry space-y-6" data-index="${index}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" id="jobPosition${index - 1}" name="experience[${index - 1}][employment_type]" class="w-full rounded-lg border border-slate-300 bg-slate-50 p-3 text-sm transition-all focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 dark:border-slate-600 dark:bg-slate-900 dark:text-white" placeholder="e.g. Full-time, Part-time, Freelance" data-rules="required|min:2" data-label="Employment Type" />
                        <p class="text-xs text-red-500 hidden mt-1" data-error="jobPosition${index - 1}"></p>
                    </div>
                </div>
        ...
        function reindexEntries() {
            ...
            entries.forEach((entry, i) => {
                ...
                entry.querySelectorAll('input, textarea').forEach(el => {
                    if (el.name) {
                        el.name = el.name.replace(/experience\[\d+\]/, `experience[${i}]`);
                    }
                });
            });
        ...
        const initialInputs = document.querySelectorAll('#experienceForm input[data-rules], #experienceForm textarea[data-rules]');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Experience form validation initialized');
            const form = document.getElementById('experienceForm');
            console.log('Form found:', !!form);

            if (form) {
                const companyInput = document.getElementById('company0');
                const companyError = document.querySelector('[data-error="company0"]');
                console.log('Company input found:', !!companyInput);
                console.log('Company error element found:', !!companyError);

                if (companyError) {
                    console.log('Error element HTML:', companyError.outerHTML);
                }
            }
        });
    </script>
