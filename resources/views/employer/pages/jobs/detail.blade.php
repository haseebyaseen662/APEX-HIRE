            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        <button class="p-2 hover:bg-surface-low rounded-full transition-colors">
                            <span class="material-symbols-outlined text-primary">arrow_back</span>
                        </button>
                        <span class="px-3 py-1 bg-primary-light text-primary text-xs font-bold rounded-full uppercase tracking-wider">
                            Active Position
                        </span>
                    </div>
                    <h2 class="text-2xl sm:text-3xl font-bold tracking-tight">Senior Product Designer</h2>
                    <div class="flex flex-wrap items-center gap-4 text-on-surface-variant/60 text-sm mt-1">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button class="gradient-primary text-white px-5 py-2 rounded-full font-bold text-xs shadow-md hover:opacity-90 transition-all flex items-center gap-1">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-surface-white rounded-xl p-6 sm:p-8 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <div class="prose prose-sm max-w-none text-on-surface-variant">
                            <p>We're looking for a Senior Product Designer to join our growing design team. You'll be responsible for designing and delivering exceptional user experiences across our product suite.</p>
                            <p>This role involves close collaboration with product managers, engineers, and other designers to create intuitive, beautiful, and functional designs that solve real user problems.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-surface-white rounded-xl p-6 sm:p-8 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <ul class="space-y-2 text-on-surface-variant">
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm mt-0.5">check</span>
                                <span>Proficiency in Figma, Sketch, or similar design tools</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm mt-0.5">check</span>
                            ...
                            <li class="flex items-start gap-2">
                                <span class="material-symbols-outlined text-primary text-sm mt-0.5">check</span>
                                <span>Strong portfolio demonstrating user-centered design process</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-surface-white rounded-xl p-6 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <div class="space-y-3">
                            <button class="w-full p-3 bg-primary-light text-primary font-bold rounded-lg hover:bg-primary/10 transition-all text-left flex items-center gap-2">
                                <span class="material-symbols-outlined text-sm">visibility</span>
                                View Applicants
                            </button>
                            <button class="w-full p-3 bg-surface-high text-on-surface font-bold rounded-lg hover:bg-surface-low transition-all text-left flex items-center gap-2">
                    ...
                    <div class="bg-surface-white rounded-xl p-6 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-on-surface-variant/60">Posted</span>
                                <span>2 weeks ago</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-on-surface-variant/60">Expires</span>
                                <span>Dec 31, 2024</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-on-surface-variant/60">Department</span>
                                <span>Design</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-on-surface-variant/60">Location</span>
