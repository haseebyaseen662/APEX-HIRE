        ...
        <div class="px-5 sm:px-8 py-2 max-w-5xl mx-auto">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="format" class="w-4 h-4 text-primary" checked>
                                    <span class="text-sm font-medium">Video Call (Zoom/Google Meet)</span>
                                </label>
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="format" class="w-4 h-4 text-primary">
                                    <span class="text-sm font-medium">In-Person</span>
                                </label>
                                <label class="flex items-center gap-3">
                                    <input type="radio" name="format" class="w-4 h-4 text-primary">
            ...
            <div class="bg-surface-white rounded-xl p-6 sm:p-8 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up mt-6">
                ...
                <textarea
                    ...
                    placeholder="Add any special instructions, preparation materials, or notes for the candidate..."
                ></textarea>
            </div>
