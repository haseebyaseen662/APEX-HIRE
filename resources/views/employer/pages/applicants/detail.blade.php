...
<main class="lg:ml-64 pt-16 pb-24 min-h-screen">
        <div class="px-5 sm:px-8 py-2 max-w-5xl mx-auto">
                    ...
                    <div class="bg-surface-white rounded-xl p-6 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm">sarah.chen@email.com</span>
                            </div>
                            <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm">Stanford University</span>
                            </div>
                            <div class="flex items-center gap-3">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-surface-white rounded-xl p-6 sm:p-8 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <div class="prose prose-sm max-w-none text-on-surface-variant">
                            ...
                            <p>I'm excited to apply for the Senior Product Designer position at your company. With over 5 years of experience in product design, I've had the opportunity to work on diverse projects that have shaped my approach to user-centered design.</p>
                            <p>My background includes leading design systems at scale, conducting user research, and collaborating closely with engineering teams to deliver exceptional user experiences. I'm particularly drawn to your company's mission and the opportunity to contribute to products that impact millions of users.</p>
                            <p>I'd love the chance to discuss how my skills and experience align with your team's needs.</p>
                    ...
                    <div class="bg-surface-white rounded-xl p-6 sm:p-8 shadow-[0_4px_20px_rgba(25,28,29,0.05)] section-card fade-up">
                        ...
                        <div class="space-y-4">
                            <div class="border-l-2 border-primary pl-4">
                                ...
                                <p class="text-sm mt-2">Led design for core product features, managed design system, conducted user research and usability testing.</p>
                            </div>
                            <div class="border-l-2 border-outline-variant pl-4">
                                ...
                                <p class="text-sm mt-2">Designed user interfaces for web and mobile applications, collaborated with cross-functional teams.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-center gap-4">
                <button class="px-6 py-3 bg-surface-high text-on-surface font-bold rounded-full border border-outline-variant/40 hover:bg-surface-low transition-all">
                    Reject Application
                </button>
                <button class="px-6 py-3 bg-blue-100 text-blue-700 font-bold rounded-full hover:bg-blue-200 transition-all">
                    Move to Next Round
                </button>
                <button class="gradient-primary text-white px-8 py-3 rounded-full font-bold shadow-md hover:opacity-90 transition-all">
                    Schedule Interview
                </button>
            </div>
