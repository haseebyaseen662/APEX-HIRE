    ...
    <div class="px-5 sm:px-8 py-2 max-w-5xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-on-surface-variant text-sm mt-1">Welcome back, {{ auth()->user()->name ?? 'Employer' }}. Here is what is happening with your recruitment funnel today.</p>
            </div>
        ...
        <div class="bg-surface-white rounded-xl p-6 sm:p-8 shadow-[0_4px_20px_rgba(25,28,29,0.05)] relative overflow-hidden section-card fade-up">
            <div class="flex justify-between items-start mb-6 gap-4">
                <div>
                    <h4 class="text-lg font-bold tracking-tight text-on-surface leading-snug">Application Activity Over Time</h4>
                    <p class="text-sm text-on-surface-variant mt-1 leading-relaxed">Monthly volume of incoming candidate applications</p>
                </div>
                <div class="flex gap-2">
                    <button class="px-3 py-1.5 rounded-full text-xs font-bold bg-surface-low text-on-surface-variant hover:bg-primary hover:text-white transition-all" type="button">
                        Weekly
                    </button>
                    <button class="px-3 py-1.5 rounded-full text-xs font-bold bg-primary text-white shadow-md" type="button">
                        Monthly
                    </button>
                </div>
            </div>
            ...
            <div class="h-64 flex items-end justify-between gap-4 px-2">
                <div class="w-full bg-surface-low rounded-t-lg h-[40%] hover:bg-primary/20 transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">120</div>
                </div>
                <div class="w-full bg-surface-low rounded-t-lg h-[65%] hover:bg-primary/20 transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">185</div>
                </div>
                <div class="w-full bg-surface-low rounded-t-lg h-[45%] hover:bg-primary/20 transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">140</div>
                </div>
                <div class="w-full bg-surface-low rounded-t-lg h-[85%] hover:bg-primary/20 transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">250</div>
                </div>
                <div class="w-full bg-surface-low rounded-t-lg h-[60%] hover:bg-primary/20 transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">170</div>
                </div>
                <div class="w-full bg-primary/40 rounded-t-lg h-[95%] hover:bg-primary transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">312</div>
                </div>
                <div class="w-full bg-primary/20 rounded-t-lg h-[75%] hover:bg-primary transition-all group relative">
                    <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity">220</div>
                </div>
            </div>
